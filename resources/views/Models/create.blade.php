...
<div class="bg-white w-5/6 mx-24 mt-10 shadow rounded-lg p-6">
    ...
    <div class="grid lg:grid-cols-2 gap-6">
        <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
            ...
            <p>
                <input id="vehicle_model_nm" name="vehicle_model_nm" autocomplete="false" tabindex="0" type="text" class="py-1 px-1 text-gray-900 outline-none block h-full w-full">
            </p>
        ...
        <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
            ...
            <p>
                <input id="year" autocomplete="false" name="year" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full">
            </p>
            <div class="text-sm text-red-700 my-1">
                @error('year')
                * {{ $message }}
        ...
        <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
            ...
            <p>
                <input id="vehicle_nm" name="vehicle_nm" autocomplete="false" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full">
            </p>
            <div class="text-sm text-red-700 my-1">
                @error('vehicle_nm')
                * {{ $message }}
        ...
        <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
            ...
            <p>
                <select name="brand_id" id="brand_id" class="py-1 px-1 appearance-none outline-none block h-full w-full">
        ...
        <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
            ...
            <p>
                <input id="mileage" name="mileage" autocomplete="false" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full">
            </p>
            <div class="text-sm text-red-700 my-1">
                @error('mileage')
                * {{ $message }}
        ...
        <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
            ...
            <p>
                <input id="capacity" name="capacity" autocomplete="false" tabindex="0" type="number" class="py-1 px-1 outline-none block h-full w-full">
            </p>
            <div class="text-sm text-red-700 my-1">
                @error('capacity')
                * {{ $message }}
        ...
        <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
            ...
            <p>
                <input id="color" name="color" autocomplete="false" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full">
            </p>
            <div class="text-sm text-red-700 my-1">
                @error('color')
                * {{ $message }}
        ...
        <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
            ...
            <p>
                <input id="driver_side" name="driver_side" autocomplete="false" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full">
            </p>
            <div class="text-sm text-red-700 my-1">
                @error('driver_side')
                * {{ $message }}
        ...
        <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
            ...
            <p>
                <input id="cost" name="cost" autocomplete="false" tabindex="0" type="text" class="py-1 px-1 outline-none block h-full w-full">
            </p>
            <div class="text-sm text-red-700 my-1">
                @error('cost')
                * {{ $message }}
        ...
        <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
            ...
            <p>
                <select name="vehicle_types_id" id="vehicle_types_id" class="py-1 px-1 appearance-none outline-none block h-full w-full">
                    <option selected disabled> Select Brands </option>
